...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/radius/analytics", component: () => import("./pages/RadiusAnalyticsPage.vue"), meta: { title: "Radius 认证分析", subtitle: "拒绝原因与 NAS 分布" } },
    { path: "/radius/accounting", component: () => import("./pages/RadiusAccountingPage.vue"), meta: { title: "Radius Accounting", subtitle: "会话流量趋势与账号排行" } },
